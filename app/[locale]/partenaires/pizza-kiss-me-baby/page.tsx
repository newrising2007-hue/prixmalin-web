...
import partenaire from "@/data/partenaires/pizza-kiss-me-baby.json";
...
export default async function PagePizzaKissMeBaby({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
    ...
    <main className="min-h-screen bg-gray-50 font-sans">
      ...
      <header className="bg-white border-b border-gray-100 shadow-sm">
        ...
        <div className="h-1.5 w-full" style={{
          background: "linear-gradient(90deg, #2eaabf 0%, #1e8a9f 40%, #ffcc00 100%)"
        }} />
        ...
        <div className="max-w-4xl mx-auto px-6 py-8 flex flex-col items-center gap-4">
          ...
          {/* Logo */}
          <Image
            src={`/partenaires/pizza-kiss-me-baby/logo.png`}
            alt={partenaire.nom}
            width={320}
            height={120}
          ...
          {/* Boutons contact */}
          <div className="flex flex-wrap justify-content gap-3 mt-2">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-6">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold tracking-wide"
          style={{ backgroundColor: "#2eaabf20", color: "#1e8a9f" }}>
          <span>🤝</span>
          ...
          {partenaire.produits.map((produit: {
            ...
            <div key={produit.nom} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
              <div className="relative w-full h-36 bg-gray-50">
                <Image
                  src={`/partenaires/pizza-kiss-me-baby/produits/${produit.image}`}
                  alt={produit.nom}
                  fill
      ...
      <section className="max-w-4xl mx-auto px-6 pb-10">
        <div className="relative overflow-hidden rounded-2xl border-2 border-dashed p-6 text-center"
          style={{ borderColor: "#2eaabf", backgroundColor: "#2eaabf15" }}>
      ...
      <footer className="bg-white border-t border-gray-100 py-8 text-center">
        ...
        {partenaire.contact?.adresse && (
          <p className="text-sm text-gray-500 mb-1">📍 {partenaire.contact.adresse}</p>
        )}
