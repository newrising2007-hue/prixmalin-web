...
export const metadata: Metadata = {
  title: "Codes bonus PC (2026) : Fortnite, LoL, World of Tanks | PrixMalin",
  description:
    "Codes bonus PC au Canada : Fortnite (V-Bucks), League of Legends (RP), World of Tanks (premium). Guides d’activation simples + offres recommandées.",
  alternates: { canonical: "/codes-bonus/pc" },
  openGraph: {
    title: "Codes bonus PC | PrixMalin Canada",
    description:
      "Fortnite, League of Legends et World of Tanks : codes bonus PC, activation, packs recommandés.",
    url: "/codes-bonus/pc",
    type: "website",
  },
}
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "L’activation dépend du jeu : Epic Games (Fortnite), Riot Client/compte Riot (LoL), compte Wargaming (World of Tanks). Les étapes sont détaillées sur chaque page jeu.",
        },
      },
      {
        "@type": "Question",
    ...
    <main className="mx-auto max-w-6xl px-4 py-10">
      <header className="mb-10">
        <h1 className="text-3xl font-bold tracking-tight">
          Codes bonus PC 🇨🇦 (Fortnite, LoL, World of Tanks)
        </h1>
        <p className="mt-3 max-w-3xl text-gray-600">
          Tu cherches des <strong>codes bonus PC</strong> au Canada ? Ici tu
          trouveras des pages dédiées aux jeux les plus populaires (Fortnite,
          League of Legends, World of Tanks) avec :{" "}
      ...
      <section className="prose prose-gray max-w-none">
        ...
        <p>
          Un code bonus PC peut donner accès à des <strong>monnaies premium</strong>{" "}
          (ex : V-Bucks, RP, or), à du <strong>temps premium</strong>, à des{" "}
          <strong>boosts</strong> ou à des <strong>cosmétiques</strong> (skins,
          packs). L’activation se fait presque toujours via le{" "}
          <strong>compte officiel</strong> du jeu ou via le <strong>launcher</strong>{" "}
          (Epic, Riot, Wargaming).
        </p>

        <h2>Ce que tu obtiens le plus souvent</h2>
        <ul>
          <li>Monnaie premium (V-Bucks, RP, or)</li>
