  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-4 pb-16 pt-10">
      ...
      <nav className="mb-6 text-sm text-neutral-600">
        ...
        <Link className="hover:underline" href="/codes-bonus/playstation">
          PlayStation
        </Link>
        <span className="mx-2">/</span>
      ...
      {items.length === 0 ? (
        <section className="rounded-2xl border border-neutral-200 bg-white p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-2 text-sm">
            <Link className="rounded-full border border-neutral-200 bg-white px-4 py-2 hover:bg-neutral-50" href="/codes-bonus/playstation">
              Retour PlayStation
            </Link>
      ...
      {Array.isArray(game.relatedSlugs) && game.relatedSlugs.length > 0 ? (
        <section className="mt-12">
          <h2 className="text-lg font-semibold">Autres jeux PlayStation</h2>
          <div className="mt-3 flex flex-wrap gap-2">
            {game.relatedSlugs.map((s) => (
              <Link
                key={s}
                href={`/codes-bonus/playstation/${s}`}
