  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-4 pb-16 pt-10">
      <header className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight">Codes bonus Nintendo (Switch) 🇨🇦</h1>
...
<div className="mt-4 flex flex-wrap gap-2 text-sm">
  ...
  <span className="rounded-full border border-blue-300 bg-blue-100 px-4 py-2 font-semibold text-blue-950 shadow-sm shadow-blue-500/10">Nintendo</span>
</div>
      </header>

      <section aria-label="Jeux Nintendo avec codes" className="grid gap-4 md:grid-cols-2">
        {cards.map((c) => (
          <Link
            key={c.href}
            href={c.href}
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              <span className="rounded-full bg-neutral-100 px-3 py-1 text-xs font-medium text-neutral-700">NS</span>
            </div>
