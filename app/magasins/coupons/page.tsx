export default function CouponsComingSoon() {
  return (
    <main className="relative min-h-screen overflow-hidden flex items-center justify-center"
      ...
      <div className="text-center px-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-3">Coupons & Rabais</h1>
        <p className="text-gray-500 mb-2">Codes promo · Grands détaillants canadiens · Économies garanties</p>
