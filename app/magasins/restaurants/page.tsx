export default function RestaurantsComingSoon() {
  return (
    <main className="relative min-h-screen overflow-hidden flex items-center justify-center"
      ...
      <div className="text-center px-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-3">Restaurants & Cafés</h1>
        <p className="text-gray-500 mb-2">Restos locaux · Distance GPS · Menus · Spécialités · Take out</p>
